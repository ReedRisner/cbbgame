...
describe('possession', () => {
  it('returns possession result', () => {
    ...
    const result = simulatePossession([p,p,p,p,p], [p,p,p,p,p], { possessionsPerGame: 70, threePointAttemptRate: 0.35, postPossessionRate: 0.2, pressRate: 0.1, zoneRate: 0.2, pnrPossessionRate: 0.3, fastBreakRate: 0.2, defAggRate: 0.2 }, { timeRemaining: 240, margin: 4 });
