...
export function generateTeams(): TeamSeed[] {
  ...
  return teams.map((t, i) => {
    ...
    return {
      ...
      boosterBudget: clampedNormal(tier === 'POWER4' ? 85 : tier === 'UPPER_MID' ? 68 : tier === 'MID' ? 55 : 40, 12, 15, 99),
      mediaMarket: clampedNormal(tier === 'POWER4' ? 78 : tier === 'UPPER_MID' ? 63 : tier === 'MID' ? 50 : 35, 14, 10, 99),
      fanIntensity: clampedNormal(tier === 'POWER4' ? 81 : tier === 'UPPER_MID' ? 69 : tier === 'MID' ? 57 : 46, 10, 20, 99),
